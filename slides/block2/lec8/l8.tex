...
\newcommand{\thisLectureNum}{\foundationsPlusNum}

\title[]{Lecture \thisLectureNum: \foundationsPlusTopic}
...
\textbf{Remember}: progress of one thread could be \textbf{blocked} by progress of other thread
...
\textbf{Remember}: this \textit{eventually} may heavily \textbf{depend on} scheduler, processor, algorithm
...
\begin{itemize}
  \pause \item \textbf{Wait-free} method: every call finishes in a finite number of steps
  \begin{itemize}
    \pause \item \textbf{Bounded wait-free} -- number of steps is bounded by some function
    \pause \item \textbf{Population-oblivious wait-free} -- number of steps independent of number of active threads
  \end{itemize}

  \pause \item \textbf{Lock-free} method: infinitely often \textit{some} method call finishes in a finite number of steps
\end{itemize}
\end{frame}

\questiontime{When I invoke \texttt{lock.lock}, \texttt{condition.await}, \texttt{thread.join} it looks like a single step. But those are definitely blocking methods. Which part of \textbf{wait-free}/\textbf{lock-free} nonblocking progress conditions forbids using of blocking methods?}
...
Nonblocking progress conditions:
\begin{itemize}
  \item \textbf{Wait-free} method: every call finishes in a finite number of steps
  \begin{itemize}
    \item \textbf{Bounded wait-free} -- number of steps is bounded by some function
    \item \textbf{Population-oblivious wait-free} -- number of steps independent of number of active threads
  \end{itemize}

  \item \textbf{Lock-free} method: infinitely often \textit{some} method call finishes in a finite number of steps
\end{itemize}

Our definitions should be \textbf{useful}. Assume blocking methods take infinite number of steps in case of thread contention (e.g mutex implemented as spin loop, condition allows arbitrary spurious wakeups ...).
...
\begin{frame}{Obstruction-free example}

{\small\url{https://github.com/Svazars/parallel-programming/tree/main/hw/block2/8.1}}
\begin{homeworkmail}{Task 8.1}
    Analyze progress properties of sample algorithm.
    \begin{itemize}
      \item \textbf{Prerequisite}: task 7.1
      \item Wait-free? 
      \item Lock-free? 
...
\begin{frame}[t]{Concurrency foundations}
...
\begin{frame}[t]{Register: supported level of concurrency}
...
\begin{frame}[t,fragile]{Register consistency: jokes to help}
...
\only<2>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/weakest1.png}
\end{center}
}

\only<3>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/weakest2.png}
\end{center}
}

\end{frame}

\begin{frame}[t]{Spoilers}
...
\only<1>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/c2/1.png}
\end{center}
}

\only<2>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/c2/2.png}
\end{center}
}

\only<3>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/c2/3.png}
\end{center}
}
...
\begin{frame}[t]{Homework: easy}

{\small\url{https://github.com/Svazars/parallel-programming/tree/main/hw/block2/8.2}}
\begin{homeworkmail}{Task 8.2}
    \begin{itemize}
      \item \textbf{Prerequisite}: task 8.1
      \item Prove that Regular MRSW Integer construction is correct and wait-free.  
    \end{itemize}
\end{homeworkmail}
...
\only<1>{
\begin{center}
  \includegraphics[width=0.6\textwidth]{./pics/sr-atomic/sr1.png}
\end{center}
}

\only<2>{
\begin{center}
  \includegraphics[width=0.6\textwidth]{./pics/sr-atomic/sr2.png}
\end{center}
}

\only<3>{
\begin{center}
  \includegraphics[width=0.6\textwidth]{./pics/sr-atomic/sr3.png}
\end{center}
}

\only<4>{
\begin{center}
  \includegraphics[width=0.6\textwidth]{./pics/sr-atomic/sr4.png}
\end{center}
}
\end{frame}
...
\only<1>{
\begin{center}
  \includegraphics[width=0.6\textwidth]{./pics/stamp/stamp1.png}
\end{center}
}

\only<2->{
\begin{center}
  \includegraphics[width=0.6\textwidth]{./pics/stamp/stamp2.png}
\end{center}
}
...
\only<1>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/snap-label/lbl1.png}
\end{center}
}

\only<2>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/snap-label/lbl2.png}
\end{center}
}

\only<3>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/snap-label/lbl3.png}
\end{center}
}

\only<4>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/snap-label/lbl4.png}
\end{center}
}

\only<5>{
\begin{center}
  \includegraphics[width=0.7\textwidth]{./pics/snap-label/lbl5.png}
\end{center}
}
\end{frame}
...
\begin{frame}[t, fragile]{Homework: medium}

{\small\url{https://github.com/Svazars/parallel-programming/tree/main/hw/block2/8.3}}
\begin{homeworkmail}{Task 8.3}
    \begin{itemize}
      \item \textbf{Prerequisite}: task 8.2
...
\begin{frame}[t, fragile]{Homework: hard}

{\small\url{https://github.com/Svazars/parallel-programming/tree/main/hw/block2/8.4}}

\begin{homeworkmail}{Task 8.4}
  \begin{itemize}
    \item \textbf{Prerequisite}: task 8.3    
...
\begin{frame}{Summary: homework}
  \texttt{Lecture \thisLectureNum, Tasks \thisLectureNum.*:} {\tiny\url{https://github.com/Svazars/parallel-programming/blob/main/hw/block2}}
\end{frame}
